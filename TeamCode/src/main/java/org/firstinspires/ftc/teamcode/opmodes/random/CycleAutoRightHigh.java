...
@Config
@Autonomous
public class CycleAutoRightHigh extends LinearOpMode {
    ...
    Pose2d Intake_POSE = new Pose2d(55, -12, Math.toRadians(0));
    ...
    public double hzslidesin = 0.2;

    public double scorearm = 0.6;

    public double scoreangle = -130;
    public double preloadangle = -130;
