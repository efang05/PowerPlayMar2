...
@Config
@Autonomous
public class CycleAutoRedRightLowLowLow extends LinearOpMode {
    Pose2d START_POSE = new Pose2d(38,-67,Math.toRadians(0));
    Pose2d Preload_POSE = new Pose2d(38,-12, Math.toRadians(0));
    Pose2d Score_POSE = new Pose2d(38,-12, Math.toRadians(0));
    Pose2d Intake_POSE = new Pose2d(56.25, -12, Math.toRadians(0));
    ...
    public double scoreangle = -160;
    public double preloadangle = -160;
